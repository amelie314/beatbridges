...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-primary-color h-screen items-center text-secondary-color">
      ...
      <Link href="/concert">
        <div className="absolute bottom-5 left-[100px] text-white bg-green-500 px-4 py-2 border border-white rounded hover:bg-green-300 transition duration-300 ease-in-out z-20 font-bold">
          Enter
        </div>
      </Link>
    </div>
